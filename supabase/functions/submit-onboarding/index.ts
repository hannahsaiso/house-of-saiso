  ...
  try {
    const response = await fetch(MAKE_WEBHOOK_URL, {
      ...
      body: JSON.stringify({
        ...
        client_id: clientData._clientId,
        ...
        preferred_channel: clientData.preferredChannel || "",
        billing_contact_name: clientData.billingContactName || "",
        billing_contact_email: clientData.billingContactEmail || "",
        ...
        non_negotiables: clientData.nonNegotiables || "",
        has_brand_guidelines: clientData.hasBrandGuidelines ?? false,
        primary_hex_codes: clientData.primaryHexCodes || "",
        north_star_goal: clientData.northStarGoal || "",
        current_benchmarks: clientData.currentBenchmarks || "",
        audience_pain_points: clientData.audiencePainPoints || "",
        typography_names: clientData.typographyNames || "",
        media_kit_link: clientData.mediaKitLink || "",
        access_granted: clientData.accessGranted || [],
        budget_range: clientData.budgetRange || "",
        brand_assets_folder: clientData.brandAssetsFolder || "",
        final_notes: clientData.finalNotes || "",
      }),
    });
